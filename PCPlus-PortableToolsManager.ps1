...
$DefaultManifest = @(
    ...
    @{
        ...
        category    = "12-DiskRepair-Recovery"
    ...
    @{
        ...
        category    = "16-MalwareSecurityCleanup"
    ...
    @{
        ...
        category    = "13-StressTesting-Benchmarks"
